    ...
    return (
        <main className="infos">
            <section className="title">
                <img src={rainbow} alt="une vague colorée en 4 bandes correspondant à la palette couleur du site" className="rainbow"></img>
                ...
                <img src={star} alt="une étoile" className="star"></img>
            </section>
